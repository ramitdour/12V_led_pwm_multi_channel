...
//23 sep 2021
//  volatile uint32_t FRAME_RATE = 1400;  // 4000*0.35 
//  volatile uint32_t FRAME_RATE_DATA = 525; //1500*0.35

//01 dec 2021
  volatile uint32_t FRAME_RATE = 300;  // 4000*0.35 
  volatile uint32_t FRAME_RATE_DATA = 550; //1500*0.35
