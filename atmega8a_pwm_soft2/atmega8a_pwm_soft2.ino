...
void loop()
{
    ...
    if(hotel == 0){
        ...
        temp_v_array_desired[6] = {255};
        }else if(hotel == 6){
        temp_v_array_desired[5] = {255};
        }else if(hotel == 7){
        temp_v_array_desired[4] = {255};
        }else if(hotel == 8){
        temp_v_array_desired[3] = {255};
        }else if(hotel == 9){
        temp_v_array_desired[2] = {255};
        }else if(hotel == 10){
          all_off();
          }else if(hotel == 11){
...
//        FRAME_RATE_DATA = 400;
    ...
    if(millis() > blinking_millis + 45000){  // 45000
        for (uint8_t j = 0; j < PWM_LEVELS; j++)
        {
          all_on(j);
          delay(4);
        ...
        delay(26000);  //26000
        isFirstFlikerFlag = !isFirstFlikerFlag;
...
//    {
//      analogWrite(pin_nos[0],j);
//      analogWrite(pin_nos[1],j);
//      analogWrite(pin_nos[2],j);
//      analogWrite(pin_nos[3],j);
//      analogWrite(pin_nos[4],j);
//      analogWrite(pin_nos[5],j);
//      
//      delay(15);
//    }
////  }
